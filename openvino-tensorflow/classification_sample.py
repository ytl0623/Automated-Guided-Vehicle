...
if __name__ == "__main__":
    ...
    font_size = .6
    color = (0, 180, 0)  # edit on 20220120
    font_thickness = 2
    ...
    while True:
        ...
        if not args.no_show:
            ...
            cv2.waitKey(0)  # add on 20220120
            outFileName = "output_" + backend_name + ".jpg"  # add on 20220121
            cv2.imwrite(outFileName, frame)  # add on 20220121
