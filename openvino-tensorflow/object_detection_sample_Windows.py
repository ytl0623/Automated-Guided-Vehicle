...
if __name__ == "__main__":
    input_file = "D:\PyCharm\openvino-tensorflow\openvino_tensorflow\examples\datagrace_hopper.jpg"
    model_file = "D:\PyCharm\openvino-tensorflow\openvino_tensorflow\examples\datayolo_v4"
    label_file = "D:\PyCharm\openvino-tensorflow\openvino_tensorflow\examples\data\coco.names"
    anchor_file = "D:\PyCharm\openvino-tensorflow\openvino_tensorflow\examples\data\yolov4_anchors.txt"
    input_height = 416
    input_width = 416
    backend_name = "CPU"
    output_dir = "."
    ...
    font_size = .6
    color = (0, 180, 0)  # edit on 20220121
    font_thickness = 2
    ...
    while True:
        ...
        if input_mode in 'image':
            ...
            outFileName = "detections_" + backend_name + ".jpg"  # add on 20220121
            cv2.imwrite(outFileName, img_bbox)  # edit on 20220121
